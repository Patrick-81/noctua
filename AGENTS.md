...
indigo/
  ...
  devices/
    ...
    mosaic.py           # Mosaïque (Lot D1) : camera_fov/plan_mosaic/expand_frames (pur, sans I/O)
web/
...
docs/                   # UTILISATION.md (guide utilisateur), CONFIGURATION.md (référence config), ARCHITECTURE.md (vue dev)
```
